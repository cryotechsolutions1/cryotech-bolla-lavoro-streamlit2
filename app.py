...
uploaded_firma_tecnico = st.file_uploader("Carica immagine firma tecnico", type=["png", "jpg"], key="firma_upload_tecnico")
st.text("Oppure firma tracciata sotto:")
canvas_tecnico = st_canvas(height=150, width=300, drawing_mode="freedraw", stroke_width=2, key="firma_canvas_tecnico")

st.header("Firma Cliente")
uploaded_firma_cliente = st.file_uploader("Carica immagine firma cliente", type=["png", "jpg"], key="firma_upload_cliente")
st.text("Oppure firma tracciata sotto:")
canvas_cliente = st_canvas(height=150, width=300, drawing_mode="freedraw", stroke_width=2, key="firma_canvas_cliente")
